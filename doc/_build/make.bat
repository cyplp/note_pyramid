...
set BUILDDIR=/home/cyp/dev/note_pyramid/doc/_build
set ALLSPHINXOPTS=-d %BUILDDIR%/doctrees %SPHINXOPTS% /home/cyp/dev/note_pyramid/doc
set I18NSPHINXOPTS=%SPHINXOPTS% /home/cyp/dev/note_pyramid/doc
if NOT "%PAPER%" == "" (
